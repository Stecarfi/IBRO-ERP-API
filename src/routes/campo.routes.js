...
router.delete('/rutas', (req, res) => campoController.eliminarTodasRutas(req, res));
router.put('/rutas/:id/cumplimiento', (req, res) => campoController.actualizarEstadoActividad(req, res));
